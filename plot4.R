...
##plot 4
png(file="C:/Users/Jason/datasciencecoursera/ExploratoryDataProjects/ExData_Plotting1/plot4.png")
...
##top right
with(d2,plot(Time,Voltage,type="l",
...
##bottom right
with(d2,plot(Time,Global_reactive_power,type="l",
